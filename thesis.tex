...
\supervisor{Josep Balasch}
\supervisorEmail{josep.balasch@KUleuven.be}
% Co-supervisor can be from an external company of your campus
\cosupervisorA{Maxim Yudayev}
\cosupervisorACompany{FIIW Campus GroepT, A. Vesaliusstraat 13, 3000 Leuven, Belgium}
\cosupervisorAEmail{maxim.yudayev@kuleuven.be}
